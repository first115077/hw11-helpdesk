...
🎯 สเต็ปที่ 5: เสกหน้าฟอร์มแจ้งซ่อม (20-45 นาที)
สร้างไฟล์ index.php ไว้ในโฟลเดอร์ src ก๊อปปี้โค้ดนี้ไปลุยเลย! (🚨 เลื่อนไปบรรทัดล่างสุดของโค้ด เพื่อแก้รหัสนักศึกษาและชื่อของตัวเองด้วย!)
PHP
<?php
